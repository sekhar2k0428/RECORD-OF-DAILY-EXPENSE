...
<head>
  ...
  <title>RECORD OF DAILY EXPENSES || DAILY EXPENDITURES</title>
...
$fdate=$_POST['fromdate'];
 $tdate=$_POST['todate'];
?>
<h5  style="color:blue">Datewise Expense Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
 ...
 <?php
$userid=$_SESSION['id'];
$ret=mysqli_query($conn,"SELECT date,SUM(pprice) as totaldaily FROM `expense`  where (date BETWEEN '$fdate' and '$tdate') && (uid='$userid') group by date");
$cnt=1;$totalsexp=0;
