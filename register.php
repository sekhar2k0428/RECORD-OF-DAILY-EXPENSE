...
if ($conn->query($sql) === TRUE) 
  ...
  <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> New Useraccount has been created 
</div>';
  } else 
  {
...
} else
{
  ...
  <span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Existing User
</div>';
}
}
?>
