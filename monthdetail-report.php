...
<body style="padding:0px;">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<h1 class="page-header">MONTHLY DETAILED EXPENSES REPORT</h1>
	</div>
...
?>
<h5  style="color:blue">Monthly Detailed Expense Report of <?php echo $month?> - <?php echo $year?></h5>
<hr />
			  ...
			  <th>Expense Date</th>
                                        ...
                                        <?php
$userid=$_SESSION['id'];
$ret=mysqli_query($conn,"SELECT * FROM expense  where (month(date)=$mon) AND (year(date)=$year) AND (uid='$userid')  ");
//$ret=mysqli_query($conn,"select month(date) as * from expense where uid='$userid' && month(date)=month($fdate)");
$cnt=1;
//$totalsexp=0;
