...
<head>
	...
	<title>RECORD OF DAILY EXPENSE|| Termly Expense Report</title>
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
						<div class="col-lg-12">
				<h1 class="page-header">TERMLY EXPENSE REPORT TRACKER</h1>
	</div>


							<form role="form" method="post" action="monthdetail-report.php" name="bwdatesreport">
